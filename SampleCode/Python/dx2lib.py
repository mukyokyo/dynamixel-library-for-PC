...
(devtNONE, devtDX, devtAX, devtRX, devtEX, devtMX, devtXL320, devtPRO, devtPROP, devtX, devtY) = range(11)
...
def DXL_GetTorqueEnable(dvid, id, en):
...
# DXL Multi
# ----------------------------
_dx2lib.DXL_SetMultipleGoalValues.argtypes = [c_void_p, POINTER(c_uint8), POINTER(c_double), c_int, c_double]
_dx2lib.DXL_SetMultipleGoalValues.restype = c_bool
def DXL_SetMultipleGoalValues(dvid, ids, values, num, sec):
  return _dx2lib.DXL_SetMultipleGoalValues(dvid, ids, values, num, sec)
