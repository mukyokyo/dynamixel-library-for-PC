/*----------------------------------------------------------*
   ...
   アドレスやモデルの差異を吸収するサブルーチン集 V3.1
                                       Last Edit '26 03/09
   Copyright (c) 2005-2026 BestTechnology CO.,LTD.
 *----------------------------------------------------------*/
/*
    ...
    if (idx >= 2) {
      switch (ModelInfoList[idx].devtype) {
        ...
        case devtPROP:
          ...
          break;
        case devtY:
          return DX2_WriteByteData (dvid, id, ADDRESS_Y_LED, en ? 1 : 0, &Devices.err[id]);
          break;
        default:
          break;
      }
    ...
    if (idx >= 2) {
      switch (ModelInfoList[idx].devtype) {
        ...
        case devtPROP:
          ...
          break;
        case devtY:
          if (DX2_WriteByteData (dvid, id, ADDRESS_Y_TORQUE_ENABLE, en ? 1 : 0, &Devices.err[id])) {
            if (DX2_ReadByteData (dvid, id, ADDRESS_Y_TORQUE_ENABLE, &ren, &Devices.err[id])) {
              return (((ren == 1) ? true : false) == en);
            }
          }
          break;
        ...
        if (id <= 252) {
          ...
          if (idx >= 2) {
            switch (ModelInfoList[idx].devtype) {
              ...
              case devtY:
                Bulk[size].id = id;
                Bulk[size].addr = ADDRESS_Y_TORQUE_ENABLE;
                Bulk[size].size = 1;
                Bulk[size].TorqueEnable = ens[i];
                size++;
                break;
    ...
    if (idx >= 2) {
      ...
      switch (ModelInfoList[idx].devtype) {
        ...
        case devtPROP:
          ...
          break;
        case devtY:
          return DX2_WriteLongData (dvid, id, ADDRESS_Y_GOAL_POSITION, pos, &Devices.err[id]);
          break;
        default:
          break;
      }
      ...
      if (id <= 252) {
        ...
        if (idx >= 2) {
          ...
          switch (ModelInfoList[idx].devtype) {
            ...
            case devtY:
              ((TBulkPRO *) (&data[size]))->id = id;
              ((TBulkPRO *) (&data[size]))->addr = ADDRESS_Y_GOAL_POSITION;
              ((TBulkPRO *) (&data[size]))->size = 4;
              ((TBulkPRO *) (&data[size]))->GoalPosition = pos;
              size += sizeof (TBulkPRO);
              break;
    ...
    if (id <= 252) {
      ...
      if (idx >= 2) {
        switch (ModelInfoList[idx].devtype) {
          ...
          case devtY: {
              int32_t pos;
              if (DX2_ReadLongData (dvid, id, ADDRESS_Y_PRESENT_POSITION, (uint32_t *)&pos, &Devices.err[id])) {
                *angle = pos2ang (pos, &ModelInfoList[idx]);
                return true;
              }
            }
    ...
    if (idx >= 2) {
      ...
      switch (ModelInfoList[idx].devtype) {
        ...
        case devtPROP:
          ...
          break;
        case devtY:
          return DX2_WriteLongData (dvid, id, ADDRESS_Y_GOAL_VELOCITY, velo, &Devices.err[id]);
          break;
        default:
          break;
      }
      ...
      if (id <= 252) {
        ...
        if (idx >= 2) {
          ...
          switch (ModelInfoList[idx].devtype) {
            ...
            case devtY:
              ((TBulkPRO *) (&data[size]))->id = id;
              ((TBulkPRO *) (&data[size]))->addr = ADDRESS_Y_GOAL_VELOCITY;
              ((TBulkPRO *) (&data[size]))->size = 4;
              ((TBulkPRO *) (&data[size]))->GoalVelocity = velo;
              size += sizeof (TBulkPRO);
              break;
    ...
    if (id <= 252) {
      ...
      if (idx >= 2) {
        switch (ModelInfoList[idx].devtype) {
          ...
          case devtY: {
              int32_t velo;
              if (DX2_ReadLongData (dvid, id, ADDRESS_Y_PRESENT_VELOCITY, (uint32_t *)&velo, &Devices.err[id])) {
                *velocity = (double)velo * ModelInfoList[idx].velocityratio;
                return true;
              }
            }
    ...
    if (idx >= 2) {
      ...
      switch (ModelInfoList[idx].devtype) {
        ...
        case devtY: {
            ...
            block.ProfileVelocity = velo;
            block.GoalPosition = pos;
            return DX2_WriteBlockData (dvid, id, 634, (uint8_t *)&block, 8, &Devices.err[id]);
          }
          break;
        default:
          break;
      ...
      if (DXL_GetPresentAngle (dvid, id, &pangle) && ((Devices.drivemode[id] & 0x4) == 0)) {
        ...
        switch (ModelInfoList[idx].devtype) {
          ...
          case devtY: {
            ...
            break;
//            return DX2_WriteLongData (dvid, id, ADDRESS_Y_PROF_VELOCITY, abs(velo), &Devices.err[id]) && DX2_WriteLongData (dvid, id, ADDRESS_Y_GOAL_POSITION, pos, &Devices.err[id]);
//            break;
          default:
            break;
        }
      ...
      if ((Devices.drivemode[id] & 0x4) != 0) {
        ...
        switch (ModelInfoList[idx].devtype) {
          ...
          case devtY: {
              ...
              block.ProfileVelocity = profileacc;
              block.GoalPosition = pos;
              return DX2_WriteBlockData (dvid, id, 642, (uint8_t *)&block, 8, &Devices.err[id]);
            }
            break;
          default:
            break;
  ...
  if (id <= 252) {
    ...
    if (idx >= 2) {
      switch (ModelInfoList[idx].devtype) {
        ...
        case devtY: {
            int16_t cur = current / ModelInfoList[idx].currentratio;
            return DX2_WriteWordData (dvid, id, ADDRESS_Y_GOAL_CURRENT, cur, &Devices.err[id]);
          }
          break;
        default:
          break;
      ...
      if (id <= 252) {
        ...
        if (idx >= 2) {
          ...
          switch (ModelInfoList[idx].devtype) {
            ...
            case devtY:
              ((TBulk *) (&data[size]))->id = id;
              ((TBulk *) (&data[size]))->addr = ADDRESS_Y_GOAL_CURRENT;
              ((TBulk *) (&data[size]))->size = 2;
              ((TBulk *) (&data[size]))->GoalCurrent = cur;
              size += sizeof (TBulk);
              break;
      ...
      if (idx >= 2) {
        ...
        switch (ModelInfoList[idx].devtype) {
          ...
          case devtPROP:
            ...
            break;
          case devtY:
            if (DX2_ReadWordData (dvid, id, ADDRESS_Y_PRESENT_CURRENT, (uint16_t *)&cur, &Devices.err[id])) {
              *current = (double)cur * ModelInfoList[idx].currentratio;
              return true;
            }
            break;
  ...
  if (id <= 252) {
    ...
    if (idx >= 2) {
      switch (ModelInfoList[idx].devtype) {
        ...
        case devtY: {
            int32_t p = max (min (pwm / ModelInfoList[idx].pwmratio, ModelInfoList[idx].pwmlimit.max), ModelInfoList[idx].pwmlimit.min);
            return DX2_WriteWordData (dvid, id, ADDRESS_Y_GOAL_PWM, p, &Devices.err[id]);
          }
          break;
        default:
          break;
      ...
      if (id <= 252) {
        ...
        if (idx >= 2) {
          ...
          switch (ModelInfoList[idx].devtype) {
            ...
            case devtY:
              ((TBulk *) (&data[size]))->id = id;
              ((TBulk *) (&data[size]))->addr = ADDRESS_Y_GOAL_PWM;
              ((TBulk *) (&data[size]))->size = 2;
              ((TBulk *) (&data[size]))->GoalPWM = pwm;
              size += sizeof (TBulk);
              break;
      ...
      if (idx >= 2) {
        ...
        switch (ModelInfoList[idx].devtype) {
          ...
          case devtPROP:
            ...
            break;
          case devtY:
            if (DX2_ReadWordData (dvid, id, ADDRESS_Y_PRESENT_PWM, (uint16_t *)&p, &Devices.err[id])) {
              *pwm = (double)p * ModelInfoList[idx].pwmratio;
              return true;
            }
            break;
...
// Set Multiple
//-------------------------------------------------
DXAPIDLL bool DXL_SetMultipleGoalValues (TDeviceID dvid, const uint8_t *ids, const double *values, int num, double sec) {
#ifdef _MSC_VER
  __pragma (pack (push, 1))
  typedef struct {
    uint8_t   id;
  ...
  typedef struct {
    ...
    uint16_t  size;
    uint16_t  MovingSpeed;
  } _PACKED_ TBulkXL320_Velo;
  typedef struct {
    uint8_t   id;
    uint16_t  addr;
    uint16_t  size;
    uint32_t  GoalVelocity;
  } _PACKED_ TBulkX_Velo;
  typedef struct {
    uint8_t   id;
    uint16_t  addr;
    uint16_t  size;
    uint32_t  GoalVelocity;
  } _PACKED_ TBulkPRO_Velo;
  ...
  typedef struct {
    ...
    uint32_t  ProfileVelocity;
    uint32_t  GoalPosition;
  } _PACKED_ TBulkPROP_PosProfVelo;
        ...
        if (idx >= 2) {
          switch (Devices.opmode[id]) {
            ...
            case 1: {   // velocity
                ...
                switch (ModelInfoList[idx].devtype) {
                  case devtXL320:
                    ...
                    break;
                  case devtX:
                    if (DX2_ReadLongData (dvid, id, ADDRESS_X_GOAL_VELOCITY, (uint32_t *)&prevvelo, &Devices.err[id])) {
                  ...
                  case devtPRO:
                    ...
                    break;
                  case devtPROP:
                    if (DX2_ReadLongData (dvid, id, ADDRESS_PROP_GOAL_VELOCITY, (uint32_t *)&prevvelo, &Devices.err[id])) {
                      if ((velo > 0 && prevvelo < 0) || (velo < 0 && prevvelo > 0)) profileacc >>= 1;
                    }
                    ...
                    break;
                  case devtY:
                    if (DX2_ReadLongData (dvid, id, ADDRESS_Y_GOAL_VELOCITY, (uint32_t *)&prevvelo, &Devices.err[id])) {
                      if ((velo > 0 && prevvelo < 0) || (velo < 0 && prevvelo > 0)) profileacc >>= 1;
                    }
                    ((TBulkPRO_VeloProfAcc *) (&data[bytes]))->id = id;
            ...
            case 3 ... 5: {   // pos + profile velo
                ...
                if ((Devices.drivemode[id] & 0x4) == 0) {
                  double pangle;
                  if (DXL_GetPresentAngle (dvid, id, &pangle)) {
          ...
          if (DXL_SetTorqueEnable (dvid, id, false)) {
            switch (ModelInfoList[idx].devtype) {
              ...
              case devtPROP:
                ...
                break;
              case devtY:
                if (DX2_WriteByteData (dvid, id, ADDRESS_Y_DRIVE_MODE, mode, &Devices.err[id])) {
                  if (DXL_GetOperatingMode (dvid, id, &rmode)) {
                    return (mode == Devices.drivemode[id]);
                  }
                }
          ...
          if (DXL_SetTorqueEnable (dvid, id, false)) {
            switch (ModelInfoList[idx].devtype) {
              ...
              case devtPROP:
                ...
                break;
              case devtY:
                if (DX2_WriteByteData (dvid, id, ADDRESS_Y_OPERATING_MODE, mode, &Devices.err[id])) {
                  if (DXL_GetOperatingMode (dvid, id, &rmode)) {
                    return (mode == rmode);
                  }
                }
      ...
      if (idx >= 2) {
        switch (ModelInfoList[idx].devtype) {
          ...
          case devtPROP:
            ...
            break;
          case devtY:
            if (DX2_ReadByteData (dvid, id, ADDRESS_Y_OPERATING_MODE, &rmode, &Devices.err[id]) && DX2_ReadByteData (dvid, id, ADDRESS_Y_DRIVE_MODE, &rdmode, &Devices.err[id])) {
              Devices.opmode[id] = (*mode = rmode);
              Devices.drivemode[id] = rdmode;
              return true;
            }
      ...
      if (idx >= 2) {
        switch (ModelInfoList[idx].devtype) {
          ...
          case devtPROP:
            ...
            break;
          case devtY:
            return DX2_ReadByteData (dvid, id, ADDRESS_Y_ERROR_CODE, hwerr, &Devices.err[id]);
            break;
          default:
            break;
        }
        ...
        if (Devices.id2model[id] == 0) {
          switch (ModelInfoList[i].devtype) {
            ...
            case devtPROP:
              ...
              break;
            case devtY:
              DX2_WriteByteData (dvid, id, ADDRESS_Y_STATUS_RETURN_LEVEL, 2, &Devices.err[id]);
              if (DX2_ReadByteData (dvid, id, ADDRESS_Y_RETURN_DELAY_TIME, &rdelay, &Devices.err[id])) {
                if (rdelay != 0) {
                  DXL_SetTorqueEnable (dvid, id, false);
                  DX2_WriteByteData (dvid, id, ADDRESS_Y_RETURN_DELAY_TIME, 0, &Devices.err[id]);
                }
              }
              if (DX2_ReadBlockData (dvid, id, 256, (uint8_t *)&indirect, 8, &Devices.err[id])) {
                if ((indirect[0] != ADDRESS_Y_PROF_VELOCITY) || (indirect[4] != ADDRESS_Y_GOAL_POSITION) || (indirect[8] != ADDRESS_Y_PROF_TIME) || (indirect[12] != ADDRESS_Y_GOAL_POSITION)) {
                  ...
                  DX2_WriteBlockData (dvid, id, 256, (uint8_t *)&indirect, 16, &Devices.err[id]);
                }
              }
              break;
            default:
...
DXAPIDLL int DXL_ScanDevices (TDeviceID dvid, uint8_t *ids) {
  ...
  uint32_t n = 253;
  TDx2AlarmStatus alm[256];
  if (DX2_Ping2 (dvid, &n, alm, NULL)) {
    for (int i = 0; i < n; i++) {
      int id = alm[i].id;
      Devices.id2model[id] = 0;
...
DXAPIDLL PDXL_ModelInfo DXL_GetModelInfoByModelNo (uint16_t modelno) {
  for (int i = 2; i < (sizeof (ModelInfoList) / sizeof (ModelInfoList[0])); i++) {
    if (ModelInfoList[i].modelno == modelno) return (PDXL_ModelInfo)&ModelInfoList[i];
  }
  return (PDXL_ModelInfo)&ModelInfoList[1];
}
